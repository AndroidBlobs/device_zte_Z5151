...
# IDC
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/configs/idc/goodix-touchscreen.idc:$(TARGET_COPY_OUT_VENDOR)/usr/idc/goodix-touchscreen.idc \
...
PRODUCT_PACKAGES += \
    ...
    qca6234-service.sh \
    switch_usb_mode.sh \
    init.fingerprint.gf3238.rc \
    init.fingerprint.silead.rc \
...
# Inherit vendor
$(call inherit-product, vendor/zte/Z5151/Z5151-vendor.mk)